...
const Cards = () => {
  const cards = [
    ...
    {title: "Meeting Timer", subtitle: "Stay on Track with Regular Check-ins",description:"Stay on Track with Regular Check-ins. Set a schedule that works for you, whether it’s hourly, daily, or weekly. If you forget, we’ll remind you cause your safety should never be an afterthought." },
